...
class Listing(models.Model):
    ...
    front_View = models.ImageField(upload_to='media', default="media/vsabre.jpg")
    interior_View = models.ImageField('Interior View', upload_to='media', default='media/vsabre.jpg')
    back_View = models.ImageField('Back View', upload_to='media', default='media/vsabre.jpg')
